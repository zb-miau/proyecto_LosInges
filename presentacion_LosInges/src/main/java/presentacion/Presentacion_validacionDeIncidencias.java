...
public class Presentacion_validacionDeIncidencias extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Presentacion_validacionDeIncidencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Presentacion_validacionDeIncidencias().setVisible(true);
            }
        });
    }
