...
/**
 * Clase de negocios que valida la información de los DTO antes de pasarlos a la
...
public class TurnoBO {
    ...
    /**
     * Método que valida la información del DTO recibido para crear un turno y
     * agregarlo a la base de datos.
     *
     * @param turno el turno a agregar.
     * @return regresa el DTO del turno creado.
     * @throws NegocioException Lanza una excepción si los datos necesarios del
     * turno están incompletos, incorrectos o si hay un error al acceder a la
     * base de datos.
     */
     ...
     * @throws NegocioException Lanza una excepción si hay un error al acceder a
     * la base de datos.
     */
     ...
     * @throws NegocioException Lanza una excepcion si hay un error en el acceso
     * a la base de datos.
     */
